        ...
        return (
            <TouchableOpacity activeOpacity={counting ? 1 : 0.8} onPress={()=>{
                ...
                <View style={[{width:120, height:44,justifyContent:'center',alignItems:'center'},style]}>
                    <Text style={[{fontSize: 16},textStyle,{color: ((!counting && enable && selfEnable) ? (textStyle ? textStyle.color : 'blue') : disableColor || 'white')}]}>{timerTitle}</Text>
                </View>
            </TouchableOpacity>
        )
    }
