        ...
        return (
            <ScrollView style={{width:dim.width,height:dim.height,borderTopWidth:0}}>
                ...
                <View style={{backgroundColor:'#fff'}}>
                    <View style={[styles.center,{marginTop:17}]}><Text style={{fontWeight:'900',color:'#333',fontSize:18}}>{this.props.navigation.state.params.tittle}</Text></View>
                    <View style={[styles.center,{marginTop:7},styles.row]}>
                        <Fg index={star1(this.props.navigation.state.params.starNumber)}></Fg>
                    </View>
