...
export default class Forget extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <KeyboardAwareScrollView>
                    ...
                    <TouchableOpacity style={styles.loginBox} onPress={this._fetchQueRen}>
    ...
    _fetchQueRen=()=>{
        ...
        let url = config.api.base + config.api.wangjimima;
        let body ={
    ...
    _fetchCode(shouldStartCountting){
        //Toast.info('获取验证码',1);
        let url = config.api.base + config.api.wangjimima_yanzhengma;
        let body ={
            phone:this.state.phoneNumber,
            sign:'1'
        }
