...
function loadIcon(val){
    if(val=="收藏"){
        return require("../../image/wode/collect.png");
    }if(val=="优惠"){
        return require("../../image/wode/coupon.png");
    }if(val=="会员"){
        return require("../../image/wode/vip.png");
    }if(val=="客服"){
        return require("../../image/wode/telephone.png");
    }if(val=="商务"){
        return require("../../image/wode/cooperation.png");
    }if(val=="关于"){
        return require("../../image/wode/about_us.png");
    }if(val=="设置"){
        return require("../../image/wode/site.png");
    }
}
